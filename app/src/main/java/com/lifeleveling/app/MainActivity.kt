...
fun NavHostContainer(
    ...
    NavHost(
        ...
        builder = {
            composable("calendar") { TempCalendarScreen() }
            composable("stats") { TempStatsScreen() }
            composable("home") { TempHomeScreen() }
            composable("streaks") { TempStreaksScreen() }
            composable("settings") { TempSettingsScreen() }
        }
    )
}
