...
val Success50_Dark = Color(0xbf66c55f)
val Error_Dark = Color(0xffe89591)
val Error50_Dark = Color(0xbfe89591)
...
val DropShadow_Light = Color(0xffa5a2a7)
val LightShadow_Light = Color(0xff5e5d5f)
val Gray_Light = Color(0xff2d2a32)
val FadedGray_Light = Color(0xff5e5d5f)
val Success_Light = Color(0xff1a4916)
val Success50_Light = Color(0xbf1a4916)
val Error_Light = Color(0xff921e19)
val Error50_Light = Color(0xbf921e19)
