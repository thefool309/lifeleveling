...
object TestUser {
    ...
    val calendarReminders = mutableStateOf(listOf(
        ...
        calReminder(isEnabled = true, id =2, day = 12,month = 12, year = 0,"shower", false,true,R.drawable.shower_bath, 7, 3, 0,0,0,0,0,1),
        calReminder(isEnabled = true, id =3, day = 12,month = 12, year = 0,"Doctor", false,false,R.drawable.shirt_color, 2, 12, 0,0,0,0,0,2),
        calReminder(isEnabled = true, id =4, day = 12,month = 12, year = 0,"TEST", true,false,R.drawable.med_bottle, 6, 12, 0,0,0,0,0,3),
        calReminder(isEnabled = true, id =5, day = 12,month = 12, year = 0,"Run", false,false,R.drawable.person_running, 1, 12, 0,0,0,0,0,1),
        calReminder(isEnabled = true, id =6, day = 12,month = 12, year = 0,"T3", false,true,R.drawable.bell, 5, 22, 0,0,0,0,0,0),
