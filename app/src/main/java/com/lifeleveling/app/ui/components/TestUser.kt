...
object TestUser {
    ...
    val calendarReminders = mutableStateOf(listOf(
        ...
        calReminder(isEnabled = true, id =4, day = 12,month = 12, year = 0,"TEST", true,true,R.drawable.med_bottle, 1, 12, 0,0,0,0,0,3),
        calReminder(isEnabled = true, id =5, day = 21,month = 4, year = 4,"Run", false,false,R.drawable.person_running, 1, 12, 0,0,0,0,0,1),
        calReminder(isEnabled = true, id =6, day = 12,month = 5, year = 4,"T3", false,false,R.drawable.bell, 1, 12, 0,0,0,0,0,0),
        calReminder(isEnabled = true, id =7, day = 2,month = 6, year = 4,"T4", false,true,R.drawable.document, 1, 12, 0,0,0,0,0,3),
