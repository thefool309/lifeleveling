...
object TestUser {
    ...
    val calendarReminders = mutableStateOf(listOf(
        calReminder(isEnabled = true, id = 1, day = 2,month = 1, year = 1,"Go to store", false,false,R.drawable.shop_color, 1, 32, 1,5,2,3,1,2),
        calReminder(isEnabled = true, id =2, day = 2,month = 1, year = 1,"shower", false,true,R.drawable.shower_bath, 1, 12, 0,0,0,0,0,4),
        calReminder(isEnabled = true, id =3, day = 3,month = 1, year = 1,"Doctor", false,false,R.drawable.shirt_color, 1, 12, 0,0,0,0,0,3),
        calReminder(isEnabled = true, id =4, day = 25,month = 3, year = 4,"TEST", true,true,R.drawable.med_bottle, 1, 12, 0,0,0,0,0,2),
